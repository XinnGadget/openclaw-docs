...
title: 提供商目录
x-i18n:
    generated_at: "2026-04-06T01:23:23Z"
    model: gpt-5.4
    provider: openai
...
1. 先通过提供商完成身份验证（通常使用 `openclaw onboard`）。
2. 设置默认模型：
...
如需查看完整的提供商目录（xAI、Groq、Mistral 等）和高级配置，请参阅 [Model providers](/zh-CN/concepts/model-providers)。
