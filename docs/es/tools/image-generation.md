...
x-i18n:
    generated_at: "2026-04-07T05:07:06Z"
    model: gpt-5.4
    provider: openai
...
3. Pídele al agente: _"Generate an image of a friendly lobster mascot."_
...
- [ComfyUI](/es/providers/comfy) — configuración de workflows locales de ComfyUI y Comfy Cloud
...
- [Models](/es/concepts/models) — configuración de modelos y conmutación por error
