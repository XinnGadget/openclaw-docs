...
summary: 采用本地优先的搜索 sidecar，支持 BM25、向量搜索、重排序和查询扩展
title: QMD 记忆引擎
x-i18n:
...
[QMD](https://github.com/tobi/qmd) 是一个本地优先的搜索 sidecar，与 OpenClaw 一同运行。它将 BM25、向量搜索和重排序整合到单个二进制文件中，并且可以索引超出你的工作区记忆文件范围的内容。
